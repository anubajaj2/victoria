sap.ui.define([	"victoria/controller/BaseController",
	...
	return Controller.extend("victoria.controller.server", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf victoria.view.View2
		 */
		oSorter: null,
		formatter: Formatter,
		simpleForm: null,
		...
		onReassign: function(oEvent) {
			...
			if (!this.oSimpleFormRe) {
				this.oSimpleFormRe = sap.ui.xmlfragment("idSimpleFormRe", "victoria.fragments.ServerSimpleForm", this);
		...
		onItemPress: function(oEvent) {
			...
			if (!this.oSimpleForm) {
				this.oSimpleForm = sap.ui.xmlfragment("idSimpleForm", "victoria.fragments.ServerSimpleForm", this);
				// connect dialog to view (models, lifecycle)
